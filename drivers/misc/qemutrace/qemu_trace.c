...
{
	unsigned long irq_flags;
	/* richard.fitzgerald@accenture.com - moved this large
	array off the stack. It's only accessed within the semaphore-
	protected block of code so safe to use a fixed memory buffer
	*/
